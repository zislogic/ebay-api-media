...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://apim.ebay.com/commerce/media/v1_beta';
    ...
    {
        $report = 'PHP SDK (Zislogic\Ebay\Api\Media\Generated) Debug Report:'.PHP_EOL;
        $report .= '    OS: '.php_uname().PHP_EOL;
        $report .= '    PHP Version: '.PHP_VERSION.PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1_beta.4.2'.PHP_EOL;
